...
This template contains the complete implementation of the Product Catalog Explore page, including the TypeScript component and SCSS styles.
...
.page-content {
  max-width: 1584px;
  margin: 0 auto;
  padding: $spacing-09 1rem $spacing-06 0;
  padding-left: 0;
  ...
  .cds--tabs {
    .cds--tab-content {
      padding: $spacing-09 0 $spacing-06 0;
    }
  }
...
### Component Structure
- **Sticky Header**: Collapses on scroll for better UX
- **Breadcrumb Navigation**: Shows current location in hierarchy
- **Search Field**: AI-powered search with ChatField component
- **Tab Navigation**: Multiple views (Explore, All products, Pricing, etc.)
- **Content Switcher**: Toggle between "View by use case" and "View by hubs"

### Carbon Components Used
- `Content`, `Grid`, `Column` - Layout structure
- `Breadcrumb`, `BreadcrumbItem` - Navigation
- `Tabs`, `TabList`, `Tab` - Tab navigation
- `Theme` - White theme for header
- `ContentSwitcher`, `Switch` - View toggle
- Carbon Icons: `Code`, `Cube`, `CloudApp`, `DataBase`, `VirtualMachine`

### Styling Features
- Responsive design with Carbon grid system
- Smooth transitions for scroll effects
- Carbon design tokens for spacing, colors, and typography
- Sticky header with dynamic padding
- Collapsible header content on scroll

### Dependencies
- `@carbon/react` - Carbon Design System components
- `@carbon/icons-react` - Carbon icon library
- Custom components: `ChatField`, `ProductCard`, `AllProductsView`

## Usage

To use this template:
1. Copy the TypeScript code to your component file
2. Copy the SCSS code to your styles file
3. Ensure all dependencies are installed
4. Import required custom components (ChatField, ProductCard, AllProductsView)
5. Adjust product data and categories as needed

---

*Template created from IBM Cloud Dashboard Product Catalog page*